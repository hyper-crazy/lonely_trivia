...
export default function BackButton({ onClick, label = "Back" }) {
  return (
    <motion.button
      ...
      className="group relative flex items-center gap-2.5 px-4 py-2 bg-zinc-900/60 backdrop-blur-xl border border-white/10 rounded-xl cursor-pointer shadow-lg overflow-hidden"
    >
      <motion.div 
