    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="group relative flex items-center justify-between p-5 bg-zinc-900/80 hover:bg-gradient-to-r hover:from-purple-600/80 hover:via-fuchsia-600/80 hover:to-pink-600/80 backdrop-blur-xl border border-white/10 hover:border-white/20 rounded-2xl shadow-[0_0_20px_rgba(236,72,153,0.15)] hover:shadow-[0_0_25px_rgba(168,85,247,0.3)] cursor-pointer text-left overflow-visible transition-all duration-300"
        >
          <ScatterSparkCluster hovered={hoveredMode === 'sprint'} />
          <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl" />
          
          <div className="relative z-10 flex items-center gap-4">
            <div className="p-3 bg-zinc-800 group-hover:bg-white/20 rounded-xl text-purple-400 group-hover:text-white transition-colors shadow-md">
              <Zap className="w-6 h-6 fill-current" />
            </div>
            <div>
              <div className="text-lg font-bold text-zinc-100 group-hover:text-white tracking-wide">Topic Sprint</div>
              <div className="text-xs text-zinc-400 group-hover:text-purple-200 transition-colors font-medium">10 Questions • 3 Lives • Leaderboard</div>
            </div>
          </div>

          <div className="relative z-10 w-9 h-9 rounded-full bg-white/5 group-hover:bg-black/20 flex items-center justify-center text-zinc-500 group-hover:text-white group-hover:translate-x-1 transition-all">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="p-3 bg-zinc-800 group-hover:bg-white/20 rounded-xl text-cyan-400 group-hover:text-white transition-colors shadow-md">
              <Compass className="w-6 h-6" />
            </div>
            <div>
              <div className="text-lg font-bold text-zinc-100 group-hover:text-white tracking-wide">Global Gauntlet</div>
              <div className="text-xs text-zinc-400 group-hover:text-purple-200 transition-colors font-medium">Universal Pool • Difficulty Tiered • 3 Lives</div>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-4">
            <div className="p-3 bg-zinc-800 group-hover:bg-white/20 rounded-xl text-pink-400 group-hover:text-white transition-colors shadow-md">
              <BookOpen className="w-6 h-6" />
            </div>
            <div>
              <div className="text-lg font-bold text-zinc-100 group-hover:text-white tracking-wide">Practice Mode</div>
              <div className="text-xs text-zinc-400 group-hover:text-purple-200 transition-colors font-medium">Endless questions • No leaderboard</div>
            </div>
          </div>
        ...
        <motion.div
          ...
          className="relative flex items-center justify-between p-5 bg-zinc-950/40 backdrop-blur-md border border-white/5 rounded-2xl text-left opacity-60 cursor-not-allowed shadow-[0_0_15px_rgba(236,72,153,0.05)]"
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-lg font-bold text-zinc-400 tracking-wide">New Mode</div>
              <div className="text-xs text-zinc-600 font-medium">Coming Soon...</div>
            </div>
          </div>
        </motion.div>
      </motion.div>
