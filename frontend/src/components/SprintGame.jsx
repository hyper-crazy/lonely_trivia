      ...
      >
        ...
        {isGameOver ? (
          <motion.div 
            ...
            className="flex flex-col items-center justify-center w-full text-center p-8 sm:p-12 bg-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl mt-4"
          >
            ...
            {/* Detailed Stats Grid Matching Layout */}
            <div className="grid grid-cols-2 gap-4 w-full mb-8 text-left bg-zinc-950/60 p-5 rounded-2xl border border-white/5 font-mono">
              <div>
                <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Final Score</div>
                <div className="text-2xl font-black text-cyan-400">{currentAccumulatedScore + score}</div>
              </div>
              <div>
                <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Lives Left</div>
                <div className="text-2xl font-black text-red-400">{lives}</div>
              </div>
              <div className="col-span-2 pt-2 border-t border-white/5">
                <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">Streaks (5x / 10x)</div>
                <div className="text-xl font-bold text-orange-400">{streakCountersRef.current.streak5} / {streakCountersRef.current.streak10}</div>
              </div>
            </div>
            ...
            <motion.div 
              ...
              className="relative overflow-hidden w-full max-w-xs py-4 bg-zinc-900 border border-white/20 rounded-2xl font-bold text-lg text-white shadow-xl cursor-pointer text-center"
            >
              <motion.div 
